...
Después de actualizar el repositorio, usa el botón **Reconstruir Todo** de TouchDesigner o ejecuta `vjcore.reload_all(); vjcore.build()` desde el Text DAT del proyecto. La reconstrucción es necesaria porque cambió el Speed CHOP, además de los shaders.
