...
Sistema de 64 escenas con control MIDI (Arturia MiniLab MkII), audio reactivo,
...
| [13 — Acabados importados](docs/13_ACABADOS_IMPORTADOS.md) | Cómo se integraron los diez proyectos `.toe` en nueve escenas ligeras |
